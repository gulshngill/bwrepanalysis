...
public class DestroyedEvent extends ReplayEvent 
{
	int unitID = 0;
	String unitType = "";
	int xloc;
	int yloc;
	public DestroyedEvent(int frames_in, int playerID_in, String data)
	{
		super(frames_in, playerID_in, ReplayEvent.Event_Destroyed);
